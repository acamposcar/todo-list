...
function updateProjectList() {
  ...
  _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.projects.forEach((project) => {
    if (project === _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.getInboxProject()) return;
...
function updateProjectTitle(project) {
  ...
  if (project === _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.getInboxProject()) {
    container.innerHTML = (`
        <h1>${project.name}</h1>`);
  } else {
    container.innerHTML = (`
    ...
    container.querySelector('.icon').addEventListener('click', () => {
      _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.deleteProject(project);
      updateProjectList();
      const inboxProject = _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.getProjectByName('Inbox');
...
const projectExample = () => {
  _project__WEBPACK_IMPORTED_MODULE_1__.app.addInbox();
  ...
  const inbox = _project__WEBPACK_IMPORTED_MODULE_1__.app.getInboxProject();
  let task;

  _project__WEBPACK_IMPORTED_MODULE_1__.app.addProject(work);

  task = new _task__WEBPACK_IMPORTED_MODULE_0__.Task('Buy groceries');
  task.addDueDate(new Date());
  task.priority = 'medium';
  personal.addTask(task);
  _project__WEBPACK_IMPORTED_MODULE_1__.app.addProject(personal);
...
const recreateProjectsFromStorage = (savedProjects) => {
  ...
  */
  savedProjects.forEach((savedProject) => {
    ...
    _project__WEBPACK_IMPORTED_MODULE_1__.app.addProject(project);
...
const readLocalStorage = () => {
  ...
  */
  _project__WEBPACK_IMPORTED_MODULE_1__.app.clearAllProjects();
...
const saveLocalStorage = () => {
  ...
  */
  localStorage.setItem('app', JSON.stringify(_project__WEBPACK_IMPORTED_MODULE_1__.app.projects));
};
...
function createNewTask(target, taskID, project) {
  ...
  */
  ...
  let task;
  if (taskID) {
    task = _project__WEBPACK_IMPORTED_MODULE_0__.app.getTaskById(taskID, project);
    task.title = title;
  } else {
    task = new Task(title);
  }
...
_logic_project__WEBPACK_IMPORTED_MODULE_1__.app.addInbox();
function getCurrentProject() {
  const currentProjectName = document.querySelector('#add-task').dataset.project;
  const [currentProject] = _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.projects.filter((project) => project.name === currentProjectName);
...
document.querySelector('#add-task-popup').addEventListener('submit', (event) => {
  ...
  if (taskID) {
    (0,_logic_task__WEBPACK_IMPORTED_MODULE_0__.createNewTask)(event.target, taskID, currentProject);
  } else {
    const task = (0,_logic_task__WEBPACK_IMPORTED_MODULE_0__.createNewTask)(event.target);
    if (!task) return;
...
document.querySelector('#add-project-popup').addEventListener('submit', (event) => {
  event.preventDefault();
  const project = (0,_logic_project__WEBPACK_IMPORTED_MODULE_1__.createNewProject)(event.target);
  _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.addProject(project);
  (0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_4__.saveLocalStorage)();
...
document.querySelector('[data-inbox]').addEventListener('click', () => {
  ...
  (0,_dom_dom__WEBPACK_IMPORTED_MODULE_2__.updateTaskList)(_logic_project__WEBPACK_IMPORTED_MODULE_1__.app.getInboxProject());
});
