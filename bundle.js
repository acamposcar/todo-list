...
/* harmony import */ var _logic_appData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../logic/appData */ "./src/logic/appData.js");
/* harmony import */ var _logic_localStorage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../logic/localStorage */ "./src/logic/localStorage.js");
...
function appendTaskElement(task, container, project) {
  ...
  element.innerHTML = (`
      ...
      <div class="due-date">${task.dueDate ? (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(task.dueDate, 'MMM do yy') : ''}</div>
  ...
  element.querySelector('.title').addEventListener('click', () => {
    _modal__WEBPACK_IMPORTED_MODULE_0__.taskModal.populateModal(task);
    _modal__WEBPACK_IMPORTED_MODULE_0__.taskModal.show();
  });
  element.querySelector('.delete-task').addEventListener('click', () => {
    project.deleteTask(task);
    _logic_localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].save();
...
function updateProjectList() {
  ...
  _logic_appData__WEBPACK_IMPORTED_MODULE_1__["default"].projects.forEach((project) => {
    if (project === _logic_appData__WEBPACK_IMPORTED_MODULE_1__["default"].getInboxProject()) return;
...
function updateProjectTitle(project) {
  ...
  if (project === _logic_appData__WEBPACK_IMPORTED_MODULE_1__["default"].getInboxProject()) {
    container.innerHTML = (`
        <h1>${project.name}</h1>`);
  } else {
    container.innerHTML = (`
    ...
    container.querySelector('.icon').addEventListener('click', () => {
      _logic_appData__WEBPACK_IMPORTED_MODULE_1__["default"].deleteProject(project);
      _logic_localStorage__WEBPACK_IMPORTED_MODULE_2__["default"].save();
      updateProjectList();
      const inboxProject = _logic_appData__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectByName('Inbox');
...
const app = (() => {
  ...
  */
  ...
  const addInbox = () => {
    ...
    app.projects.push(new _project__WEBPACK_IMPORTED_MODULE_0__.Project(inboxName));
  };
...
/* harmony import */ var _appData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./appData */ "./src/logic/appData.js");
...
const storage = (() => {
  ...
  */
  const projectSampleData = () => {
    ...
    *  Create sample data
    */
    _appData__WEBPACK_IMPORTED_MODULE_2__["default"].addInbox();
    const work = new _project__WEBPACK_IMPORTED_MODULE_1__.Project('Work');
    const personal = new _project__WEBPACK_IMPORTED_MODULE_1__.Project('Personal');
    const inbox = _appData__WEBPACK_IMPORTED_MODULE_2__["default"].getInboxProject();
    let task;

    _appData__WEBPACK_IMPORTED_MODULE_2__["default"].addProject(work);

    task = new _task__WEBPACK_IMPORTED_MODULE_0__.Task('Buy groceries');
    task.addDueDate(new Date());
    task.priority = 'medium';
    personal.addTask(task);
    _appData__WEBPACK_IMPORTED_MODULE_2__["default"].addProject(personal);

    task = new _task__WEBPACK_IMPORTED_MODULE_0__.Task('Learn React');
    task.addDueDate(new Date());
    task.priority = 'high';
    inbox.addTask(task);
    task = new _task__WEBPACK_IMPORTED_MODULE_0__.Task('Study algorithms');
    task.addDueDate(new Date());
    task.priority = 'medium';
    inbox.addTask(task);
  };
  ...
  const recreateProjects = (savedProjects) => {
    ...
    */
    savedProjects.forEach((savedProject) => {
      const project = new _project__WEBPACK_IMPORTED_MODULE_1__.Project(savedProject.name);
      _appData__WEBPACK_IMPORTED_MODULE_2__["default"].addProject(project);
  ...
  const read = () => {
    ...
    */
    _appData__WEBPACK_IMPORTED_MODULE_2__["default"].clearAllProjects();
  ...
  const save = () => {
    ...
    */
    localStorage.setItem('app', JSON.stringify(_appData__WEBPACK_IMPORTED_MODULE_2__["default"].projects));
  };
...
/* harmony import */ var _appData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./appData */ "./src/logic/appData.js");
...
class Task {
  ...
  addDueDate = (date) => {
    ...
    if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(parseDate)) return;
...
function saveTask(target, taskID, project) {
  ...
  */
  ...
  if (taskID) {
    // Edit task
    task = _appData__WEBPACK_IMPORTED_MODULE_0__["default"].getTaskById(taskID, project);
    task.title = title;
  } else {
    // Create new task
    task = new Task(title);
...
/* harmony import */ var _logic_localStorage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./logic/localStorage */ "./src/logic/localStorage.js");
/* harmony import */ var _logic_appData__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./logic/appData */ "./src/logic/appData.js");
...
_logic_localStorage__WEBPACK_IMPORTED_MODULE_4__["default"].read();
_logic_appData__WEBPACK_IMPORTED_MODULE_5__["default"].addInbox();
function getCurrentProject() {
  const currentProjectName = document.querySelector('#add-task').dataset.project;
  const [currentProject] = _logic_appData__WEBPACK_IMPORTED_MODULE_5__["default"].projects.filter((project) => project.name === currentProjectName);
...
document.querySelector('#add-task-popup').addEventListener('submit', (event) => {
  ...
  if (taskID) {
    (0,_logic_task__WEBPACK_IMPORTED_MODULE_0__.saveTask)(event.target, taskID, currentProject);
  } else {
    const task = (0,_logic_task__WEBPACK_IMPORTED_MODULE_0__.saveTask)(event.target);
    if (!task) return;
    currentProject.addTask(task);
  }
  _logic_localStorage__WEBPACK_IMPORTED_MODULE_4__["default"].save();
  _dom_modal__WEBPACK_IMPORTED_MODULE_3__.taskModal.clearAndHide(event.target);
  (0,_dom_dom__WEBPACK_IMPORTED_MODULE_2__.updateTaskList)(currentProject);
});

document.querySelector('#add-task-cancel').addEventListener('click', () => {
  const popup = document.querySelector('#add-task-popup');
  _dom_modal__WEBPACK_IMPORTED_MODULE_3__.taskModal.clearAndHide(popup);
});

document.querySelector('#add-project').addEventListener('click', () => {
  _dom_modal__WEBPACK_IMPORTED_MODULE_3__.projectModal.show();
});

document.querySelector('#add-project-popup').addEventListener('submit', (event) => {
  event.preventDefault();
  const project = (0,_logic_project__WEBPACK_IMPORTED_MODULE_1__.saveProject)(event.target);
  _logic_appData__WEBPACK_IMPORTED_MODULE_5__["default"].addProject(project);
  _logic_localStorage__WEBPACK_IMPORTED_MODULE_4__["default"].save();
  _dom_modal__WEBPACK_IMPORTED_MODULE_3__.projectModal.clearAndHide(event.target);
  (0,_dom_dom__WEBPACK_IMPORTED_MODULE_2__.updateProjectList)();
});

document.querySelector('#add-project-cancel').addEventListener('click', () => {
  const popup = document.querySelector('#add-project-popup');
  _dom_modal__WEBPACK_IMPORTED_MODULE_3__.projectModal.clearAndHide(popup);
});

document.querySelector('[data-inbox]').addEventListener('click', () => {
  (0,_dom_dom__WEBPACK_IMPORTED_MODULE_2__.changeActiveProject)(document.querySelector('[data-inbox]'));
  (0,_dom_dom__WEBPACK_IMPORTED_MODULE_2__.updateTaskList)(_logic_appData__WEBPACK_IMPORTED_MODULE_5__["default"].getInboxProject());
});
