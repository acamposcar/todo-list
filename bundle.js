...
function appendTaskElement(task, container, project) {
  ...
  element.querySelector('.delete-task').addEventListener('click', () => {
    ...
    (0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_2__.saveLocalStorage)();
    element.remove();
  });
}
...
(0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_4__.readLocalStorage)();
...
document.querySelector('#add-task-popup').addEventListener('submit', (event) => {
  ...
  (0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_4__.saveLocalStorage)();
