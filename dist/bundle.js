...
function appendTaskElement(task, container, project) {
  ...
  element.querySelector('.delete-task').addEventListener('click', () => {
    ...
    (0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_2__.saveLocalStorage)(_logic_project__WEBPACK_IMPORTED_MODULE_1__.app);
    element.remove();
  });
}
...
function updateProjectTitle(project) {
  ...
  console.log(_logic_project__WEBPACK_IMPORTED_MODULE_1__.app);
...
(0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_4__.readLocalStorage)(_logic_project__WEBPACK_IMPORTED_MODULE_1__.app);
...
document.querySelector('#add-task-popup').addEventListener('submit', (event) => {
  ...
  (0,_logic_localStorage__WEBPACK_IMPORTED_MODULE_4__.saveLocalStorage)(_logic_project__WEBPACK_IMPORTED_MODULE_1__.app);
