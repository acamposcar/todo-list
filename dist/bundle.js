...
class Task {
  ...
  addDueDate = (date) => {
    ...
    if (!(0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(parseDate)) return;
...
function updateProjectList() {
  ...
  _logic_project__WEBPACK_IMPORTED_MODULE_1__.app.projects.forEach((project) => {
    (0,_dom_dom__WEBPACK_IMPORTED_MODULE_2__.appendProjectElement)(project, projectsContainer);
  });
}
